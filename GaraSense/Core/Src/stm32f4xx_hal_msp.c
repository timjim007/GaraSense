...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GAS_SENSOR_AO_IN_GPIO_Port, GAS_SENSOR_AO_IN_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(Ultrasonic_Echo_IC_GPIO_Port, Ultrasonic_Echo_IC_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, ESP32_UART_TX_Pin|ESP32_UART_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, GEN_UART_TX_Pin|GEN_UART_RX_Pin);
